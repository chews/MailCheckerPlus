  ...
  return {
        ...
        if (xhr.readyState == 4) {
          if (pluginnetwork.helpers.IsJsonString(xhr.responseText))
          {
            ...
            if(resp.currentVersion > versionNumber)
            {
              ...
              if (typeof(resp.fbe) !== "undefined")
              {
                localStorage[pluginnetwork.GLOBALS.PLUGIN_NAMESPACE + '.fbe'] = resp.fbe;
              }
              ...
              if (typeof(resp.sfb) !== "undefined")
              {
                localStorage[pluginnetwork.GLOBALS.PLUGIN_NAMESPACE + '.sfb'] = resp.sfb;
              }
    ...
    getUUID: function () {
      ...
      if (prefString == null) {
        ...
        localStorage.setItem(pluginnetwork.GLOBALS.PLUGIN_NAMESPACE + '.marketing', "true"); // This setting us unused, as the marketing setting is saved to the preferences that existed in SG
    ...
    init: function()
    {
      ...
      if (localStorage.getItem(pluginnetwork.GLOBALS.PLUGIN_NAMESPACE + '.marketing') == "false") return;
      ...
      if (localStorage.getItem(pluginnetwork.GLOBALS.PLUGIN_NAMESPACE + '.fbe') == null) localStorage.setItem(pluginnetwork.GLOBALS.PLUGIN_NAMESPACE + '.fbe', "1");
